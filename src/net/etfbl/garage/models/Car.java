...
public class Car extends Vehicle {
    ...
    public void setNumberOfDoors(int carryWeight) {
        this.numberOfDoors=carryWeight;
    }

    public Car(String name, String chassisNumber, String engineNumber, String registration, File photo, int numberOfDoors) {
        super(name,chassisNumber,engineNumber,registration);
        this.photo = photo;
        this.numberOfDoors = numberOfDoors;
    }

    public Car(String name, String chassisNumber, String engineNumber, String registration) {
        super(name,chassisNumber,engineNumber,registration);
    }
