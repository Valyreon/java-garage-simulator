...
public class PoliceVan extends Van implements Police {
    ...
    public PoliceVan(String name, String chassisNumber, String engineNumber, String registration, File photo, int carryWeight, File wantedList) {
        super(name, chassisNumber, engineNumber, registration, photo, carryWeight);
        this.wantedList = wantedList;
        readWantedFile();
    }

    public PoliceVan(String name, String chassisNumber, String engineNumber, String registration) {
