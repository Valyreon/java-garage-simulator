...
public class MedicalVan extends Van implements Medical {
    boolean rotation = false;
    private Vehicle target = null;

    public MedicalVan(String name, String chassisNumber, String engineNumber, String registration, File photo, int carryWeight) {
        super(name, chassisNumber, engineNumber, registration, photo, carryWeight);
    }

    public MedicalVan(String name, String chassisNumber, String engineNumber, String registration) {
