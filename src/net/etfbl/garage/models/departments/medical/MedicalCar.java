package net.etfbl.garage.models.departments.medical;
...
public class MedicalCar extends Car implements Medical {
    boolean rotation = false;
    private Vehicle target = null;

    public MedicalCar(String name, String chassisNumber, String engineNumber, String registration, File photo, int numberOfDoors) {
        super(name, chassisNumber, engineNumber, registration, photo, numberOfDoors);
    }

    public MedicalCar(String name, String chassisNumber, String engineNumber, String registration) {
